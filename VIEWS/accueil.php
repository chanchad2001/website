    ...
    <div id="fh5co-counter" class="fh5co-counters">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 col-md-pull-8 animate-box">
							<div class="mt">
								<h3>Voulez vous apprendre un language de programmation ?</h3>
								<p>Eh bien, c'est ici. de nombreux cours vous permettront de débuter dans le mondre de Programmation.</p>
								<ul class="list-nav">
									<li><i class="icon-check2"></i>Cours, simple, clair, et ludique</li>
									<li><i class="icon-check2"></i>Vidéos, pour vous aider.</li>
									<li><i class="icon-check2"></i>Exercies, pour tester vos connaissances.</li>
								</ul>
								<p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="https://vimeo.com/channels/staffpicks/93951774"><i class="icon-play"></i> Regarder la vidéo</a></p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 animate-box">
							<div class="mt">
								<div>
									<h4><i class="icon-user"></i>Une communauté grandissante</h4>
									<p>Tous les jours de nouveaux developpeurs ainsi que des débutant rejoignent le site. </p>
								</div>
								<div>
									<h4><i class="icon-video2"></i>Du contenu clair et ludique pour apprendre</h4>
									<p>Le site propose pour ses tutoriels une vidéo, un cour et des exercices. </p>
								</div>
								<div>
									<h4><i class="icon-shield"></i>Par la communauté pour la commmunauté</h4>
									<p>Les tutoriels sont gratuits et open source vous pouvez vous même en creer un. </p>
								</div>
							</div>
						</div>
					</div>
		...
		<div id="fh5co-project">
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
						<h2>Decouvrez des projets terminés</h2>
						<p>Presentez vos projets afin de les mettre en avant et de gagner de l'argent.</p>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="features">
						<div class="col-md-4 animate-box">
							<h4>Projet réalisé par la communauté</h4>
							<p>Il n'est pas obligé que vous soyez diplomé pour montrer vos projets. Juste que vous soiyez motivé !  </p>
						</div>
						<div class="col-md-4 animate-box">
							<h4>Des cours disponible dès maintenant</h4>
							<p>Entrez dans le monde de la programmation grâce a nos cours ! Peut-être posterez vous un projet.  </p>
						</div>
						<div class="col-md-4 animate-box">
							<h4>Un site communautaire</h4>
							<p>Discutez avec la communauté afin de poser ou de répondre a des questions.  </p>
						</div>
					</div>
					<div class="col-md-12 text-center animate-box">
						<p><a class="btn btn-primary btn-lg btn-learn" href="#">Creer un cours/tutoriel gratuit</a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="fh5co-steps">
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
						<h2>Comment proposer un Tutoriel</h2>
						<p>Les tutoriels peuvent etre partiellement gratuits et sont verifié avant d'être posté.</p>
					</div>
				</div>
				...
				<div class="row bs-wizard animate-box" style="border-bottom:0;">
					...
					<div class="col-xs-3 bs-wizard-step complete">
						...
						<div class="bs-wizard-info text-center"><p>Creer votre Cours / Tutoriel</p></div>
					</div>
					...
					<div class="col-xs-3 bs-wizard-step active"><!-- complete -->
						...
						<div class="progress"><div class="progress-bar"></div></div>
						<a href="#" class="bs-wizard-dot"></a>
						<div class="bs-wizard-info text-center"><p>Uploadez le !</p></div>
					</div>
					...
					<div class="col-xs-3 bs-wizard-step disabled"><!-- complete -->
						...
						<div class="progress"><div class="progress-bar"></div></div>
						<a href="#" class="bs-wizard-dot"></a>
						<div class="bs-wizard-info text-center"><p>Mettez le en forme</p></div>
					</div>
					...
					<div class="col-xs-3 bs-wizard-step disabled"><!-- active -->
						...
						<div class="progress"><div class="progress-bar"></div></div>
						<a href="#" class="bs-wizard-dot"></a>
						<div class="bs-wizard-info text-center"><p>Partagez-le !</p></div>
					</div>
				</div>
		...
		<div id="fh5co-testimonial" class="fh5co-bg-section">
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
						<h2>(Fake) Avis de la communauté</h2>
					</div>
				</div>
				<div class="row">
